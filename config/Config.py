...
# geckodriver（谷歌的selenium驱动）的安装路径
GECKODRIVER_PATH = r'D://SystemSoftware/ISP/Google/Chrome/Application/chrome.exe'

# fofa 账号密码
FOFA_USER = '2275908981@qq.com'
FOFA_PASS = 'Zjwdqccyx1'

# zooyeye（钟馗之眼）账号密码
ZOOMEYE_USER = '2275908981@qq.com'
ZOOMEYE_PASS = 'zjwdqccyx1'

# qianxin配置
# qianxin（奇安信）api-key（登录之后就可以获取）
QIANXIN_API_KEY = '9797e6f7f35a76f2e5370fd5ba5ba00f7196726ee37c6e27d9681951845bcdd2'
# qianxin 查询开始时间，默认是当前时间的一年前，也就是查询一年以内的数据
